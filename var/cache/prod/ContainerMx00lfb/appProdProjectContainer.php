...
class appProdProjectContainer extends Container
{
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('5wG8jdrRcK', 0, ($this->targetDirs[0].'/pools'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf_orm_default_639163f3e90f39852fb06699938d307263eaa26b31393e6f3f02037ea12920b8');
    ...
    {
        return $this->services['fragment.listener'] = new \Symfony\Component\HttpKernel\EventListener\FragmentListener(${($_ = isset($this->services['uri_signer']) ? $this->services['uri_signer'] : ($this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('AHoaFSaed0MCCWeRaH77uTfgXZarHxX8Jt0mut2QOcGpaHFVVfNrJLVC'))) && false ?: '_'}, '/_fragment');
    }
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('AHoaFSaed0MCCWeRaH77uTfgXZarHxX8Jt0mut2QOcGpaHFVVfNrJLVC');
    }
    ...
    protected function getDefaultParameters()
    {
        return [
            ...
            'kernel.secret' => 'AHoaFSaed0MCCWeRaH77uTfgXZarHxX8Jt0mut2QOcGpaHFVVfNrJLVC',
